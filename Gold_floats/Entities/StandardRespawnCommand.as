...
void InitClasses(CBlob@ this)
{
	...
	AddIconToken("$knight_class_icon$", "KnightClassIcons.png", Vec2f(32, 32), 0);
	AddIconToken("$grappleknight_class_icon$", "KnightClassIcons.png", Vec2f(32, 32), 1);
	...
	addPlayerClass(this, "Grapple Knight", "$grappleknight_class_icon$", "grappleknight", "Hack and Slash.");
